...
print("Bao lâu thì bán được 1 tỷ gói mè?")
...
def clone():
    ...
    try:
        r = requests.get("https://api.proxyscrape.com/v2/?request=getproxies&protocol=socks5")
        f.write(r.content)
    except:
        pass
    try:
        ...
        pass
    try:
        r = requests.get("https://openproxy.space/list/socks5")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://openproxylist.xyz/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://proxysearcher.sourceforge.net/Proxy%20List.php?type=socks&filtered=true")
        f.write(r.content)
    except:
        pass
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/ALIILAPRO/Proxy/main/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/Anonym0usWork1221/Free-Proxies/main/proxy_files/socks5_proxies.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/B4RC0DE-TM/proxy-list/main/SOCKS5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/ErcinDedeoglu/proxies/main/proxies/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/iptotal/free-proxy-list/master/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/MuRongPIG/Proxy-Master/main/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/NotUnko/autoproxies/main/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/officialputuid/KangProxy/KangProxy/socks5/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/proxylist-to/proxy-list/main/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/prxchk/proxy-list/main/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/steamboatid/proxyout/main/proxy-socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        ...
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/TylerAmesIsGay/proxy-list/main/socks5_proxies.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/yemixzy/proxy-list/main/proxies/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/Zaeem20/FREE_PROXIES_LIST/master/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/zevtyardt/proxy-list/main/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://raw.githubusercontent.com/zloi-user/hideip.me/main/socks5.txt")
        f.write(r.content)
    except:
        pass
    try:
        r = requests.get("https://spys.me/socks.txt")
        f.write(r.content)
    except:
        pass
    try:
...
def main():
    ...
    print ("Số proxy hiện có: %s" %(len(lines)))
